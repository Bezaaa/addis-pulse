...
import { Building2, MapPin, Star, Users, Heart, Compass } from "lucide-react";
...
export default function SavedPage() {
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-5 sm:p-6 lg:p-8">
      ...
      {/* Summary pill */}
      <div className="flex w-fit items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 dark:border-dark-300 dark:bg-dark-100">
