    ...
    <div className="mx-auto max-w-7xl space-y-6 p-5 sm:p-6 lg:p-8">
      ...
      <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
        {SPACES.map((space) => (
          ...
          >
            {/* Card header */}
            <div className={`relative h-32 ${space.bg}`}>
              <Building2
                className={`absolute right-4 top-1/2 h-24 w-24 -translate-y-1/2 opacity-[0.08] ${space.accent}`}
              />
              <Badge
              ...
              <div className="absolute bottom-3 left-4 flex items-center gap-1.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-black/25 backdrop-blur-sm">
                  <Wifi className={`h-4 w-4 ${space.accent}`} />
                </div>
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-black/25 backdrop-blur-sm">
                  <Coffee className={`h-4 w-4 ${space.accent}`} />
                </div>
              </div>
            </div>
